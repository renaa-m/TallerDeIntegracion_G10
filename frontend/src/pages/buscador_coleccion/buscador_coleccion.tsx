...
const CORPUS: Resultado[] = [
  {
    ...
    fuenteTipo: 'PDF',
    extracto: 'El diagnóstico diferencial incluye lupus eritematoso sistémico, sarcoidosis y vasculitis. El equipo de reumatología sugiere iniciar con prednisona 40mg diarios.',
    pagina: 12,
  },
  {
    id: 2,
    ...
    fuenteTitulo: 'Especificaciones Técnicas Dr. House',
    fuenteTipo: 'PDF',
    extracto: 'Resultados de laboratorio muestran ANA positivo 1:640 con patrón homogéneo, complemento C3 bajo y anti-dsDNA elevado.',
    pagina: 18,
  },
  {
    id: 3,
    ...
    fuenteTipo: 'Doc',
    extracto: 'Se acordó presentar los avances del proyecto de análisis semántico en el congreso de junio. Responsable: equipo de NLP.',
  }
]
...
const BuscadorColeccion = () => {
  ...
  const resultados = CORPUS.filter((r) => {
    ...
    const matchPersonas = personas.length === 0 || personas.some(p => texto.includes(p.toLowerCase()))
    const matchEventos = eventos.length === 0 || eventos.some(e => texto.includes(e.toLowerCase()))
        ...
        <main className="bc-main">
          <header className="bc-topbar">
            <div className="bc-topbar-left">
              ...
              <span className="bc-topbar-sub">Colección activa</span>
            </div>
          </header>
          ...
          <div className="bc-searchbar-wrap">
            <div className="bc-searchbar">
              ...
              />
              {busqueda && (
                <button className="bc-searchbar-clear" onClick={handleClearBusqueda}><X size={14} /></button>
              )}
          ...
          <div className="bc-results-area">
            {!busquedaEnviada ? (
              <div className="bc-empty">
                ...
                <p className="bc-empty-sub">Presiona Enter para buscar.</p>
              </div>
            ) : resultados.length === 0 ? (
              <div className="bc-empty">
