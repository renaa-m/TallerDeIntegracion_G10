...
let mockAuthState: {
    ...
    test('abre y cierra dropdown del perfil', () => {
        ...
        const trigger = document.querySelector('.profile-trigger') as HTMLButtonElement
    ...
    test('muestra avatar placeholder si usuario no tiene picture', () => {
        ...
        expect(document.querySelector('.nav-avatar-placeholder')).toBeInTheDocument()
    ...
    test('cierra modal eliminar cuenta', () => {
        ...
        expect(screen.queryByTestId('modal-eliminar-cuenta')).not.toBeInTheDocument()
    })
