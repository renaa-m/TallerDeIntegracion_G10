    ...
    <div className="mea-overlay" onClick={onClose}>
      <div className="mea-box" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="mea-icon-wrap">
          ...
          <svg className="mea-icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <p className="mea-text">
          ...
          {nombreColeccion
            ? <><span className="mea-filename">"{nombreColeccion}"</span>{' '}permanentemente?</>
